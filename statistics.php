...
function stats($username) {
    ...
    $content.='</tbody></table>';
    $content.='<div class="audioname_stats" style=""></div><div class="container monthavg"><div class="row"><div class="col-xs-6">Total income for this month (before tax) is: </div><div class="col-xs-6"><img src="icons/coin_gold.png"/> <span class="total"></span></div></div>'
