...
//                   alert('The entry can\'t get deleted.');
    ...
    $(".trumbowyg-button-pane").append('<li><button style="background-image: url(../icons/add2.png); background-repeat: no-repeat; background-position:5px, 5px;" class="" id="mybtn">t</button></li>');
    $(".trumbowyg-button-pane").append('<li><button style="background-image: url(../icons/del2.png); background-repeat: no-repeat; background-position:5px, 5px;" class="" id="mybtn2">t</button></li>');
