...
var dashboard = function() {
    ...
    this.start=function() {
	   ...
	   $('.notepad').html('<table style="width: 100%; border="1" id="t1"><tbody><tr><td style="width:5%">Zeit</td><td style="width:90%">Fehler</td><td style="width:5%">Status</td></tr><tr><td><br></td><td><br></td><td><br></td></tr></tbody></table><br><h5>Comments</h5><br>');
        }
        else if(data==="0") {
            alert("Something went wrong.");
        }
