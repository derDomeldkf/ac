...
if($user["is_logged_in"]) {
    ...
    if(date("j")>15) {
        $first_day=date("Y-m")."-30 00:00:00";;
    }
    else {
        $first_day=date("Y-m", strtotime("now -1 month"))."-30 00:00:00";
    }
    ...
    $content.='<div class="container lastc" style="display:none"><h2>Notepad</h2><p>Notes are saved nearly in real time. Current status: <img src="icons/valid.png" alt="Saved" id="notestatus"/></p><div class="notepad"></div></div>';
